...
class UNET(nn.Module):
    def __init__(
        ...
        self.grl2=GRL(3,2)
        #self.grl4 = GRL(3, 4)
        self.last=nn.ConvTranspose2d(64, 61, kernel_size=2, stride=2)
        # self.final_layer1 = nn.Conv2d(64, 32, kernel_size=3,stride=1,padding=1)
